                    ...
                    <div key={spot.id} className='individual-spot-container'>
                        <NavLink to={`/spots/${spot.id}`}>
                            <img className='spot-card'
                                 src={spot?.previewImage || ''} onError={ (e) => (e.target.src = 'https://www.pngkey.com/png/detail/233-2332677_image-500580-placeholder-transparent.png')}
                                 alt='one-spot-card'/>
                            ...
                            <div className='spot-description-container'>
                                ...
                                <div id='spot-description-right'>
                                    <div id='spot-prop-3'><i className="fa-solid fa-star"></i> {spot?.avgRating?.toFixed(1) || 0 }</div>
